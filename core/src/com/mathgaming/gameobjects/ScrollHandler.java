...
public class ScrollHandler {
	...
	public ScrollHandler(float yPos){
		...
		largePlatform1 = new Platform(10, 360, 84*4, 10*4, -240); //last arg is SCROLLSPEED< add constant -JTO
		ground = new Platform(0, 560, 250*4, 20*4, -350); // Need the foreground to run faster than background for a parallax effect -JTO
